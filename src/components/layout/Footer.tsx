                        ...
                        <div className="flex gap-3">
                            {settings.instagram && (
                                <a
                                    ...
                                    className="w-10 h-10 bg-slate-800 hover:bg-gradient-to-tr hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 rounded-lg flex items-center justify-center transition-all"
                                >
                                    <Instagram size={18} />
                                </a>
                            )}
