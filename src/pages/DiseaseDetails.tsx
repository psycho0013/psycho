...
const DiseaseDetails = () => {
    ...
    useEffect(() => {
        ...
        const diseasesList = storedDiseases ? JSON.parse(storedDiseases) : defaultDiseases;
        const treatmentsList = storedTreatments ? JSON.parse(storedTreatments) : defaultTreatments;

        const foundDisease = diseasesList.find((d: Disease) => d.id === id);
        setDisease(foundDisease || null);
        setDiseasesTreatments(treatmentsList);
    }, [id]);
